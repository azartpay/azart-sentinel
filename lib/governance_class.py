...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to azartd "gobject list" output
    ...
    def azartd_serialise(self):
        import azartlib
        return azartlib.SHIM_serialise_for_azartd(self.serialise())
